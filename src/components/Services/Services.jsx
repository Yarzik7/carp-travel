    ...
    >
      <div className="absolute top-[0] left-[0] z-[2] w-full h-full py-[56px] md:py-[64px] lg:py-[80px] pointer-events-none">
        <Container containerClasses="h-full md:flex md:justify-between">
          ...
          <div className="smOnly:mt-[24px] uppercase">
            <p className="text-[43px] font-thin smOnly:text-right md:text-[67px] mdOnly:leading-[1.16]">
              0{activeSlide + 1}/
              <span className="text-white/20">0{servicesList.length}</span>
            </p>
            <ul className="mt-[289px] flex flex-col gap-[16px] md:mt-[40px]">
